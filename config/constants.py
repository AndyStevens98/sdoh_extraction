...
STATUS_TIME_CLASSES = [NONE, CURRENT, PAST, FUTURE, UNKNOWN]

SUBTYPES = STATUS_TIME_CLASSES


ARGUMENTS_BY_EVENT_TYPE = {}
ARGUMENTS_BY_EVENT_TYPE[ALCOHOL] = [STATUS_TIME, TYPE, TEMPORAL, METHOD, AMOUNT, FREQUENCY, HISTORY, EXPOSURE_HISTORY, QUIT_HISTORY]
...
ARGUMENTS_BY_EVENT_TYPE[OCCUPATION] = [STATUS_TIME, TYPE, TEMPORAL, METHOD, LOCATION, EXTENT]
ARGUMENTS_BY_EVENT_TYPE[MARITAL_STATUS] = [STATUS_TIME, TYPE, TEMPORAL, AMOUNT]
ARGUMENTS_BY_EVENT_TYPE[RESIDENCE] = [STATUS_TIME, TYPE, TEMPORAL, METHOD, LOCATION]
...
ARGUMENTS_BY_EVENT_TYPE[LIVING_SITUATION] = [STATUS_TIME, TEMPORAL, METHOD]
...
ARGUMENTS_BY_EVENT_TYPE[PHYSICAL_ACTIVITY] = [STATUS_TIME, TYPE, TEMPORAL, AMOUNT, FREQUENCY]
ARGUMENTS_BY_EVENT_TYPE[WEIGHT_MANAGE] = [STATUS_TIME, TYPE, TEMPORAL, METHOD, AMOUNT]
...
ARGUMENTS_BY_EVENT_TYPE[INFECT_DISEASES] = [STATUS_TIME, TYPE, TEMPORAL]
...
REQUIRED_ARGUMENTS[ALCOHOL] = []
REQUIRED_ARGUMENTS[DRUG] = []
REQUIRED_ARGUMENTS[TOBACCO] = []
ARGUMENTS_BY_EVENT_TYPE[OCCUPATION] = []
ARGUMENTS_BY_EVENT_TYPE[MARITAL_STATUS] = []
ARGUMENTS_BY_EVENT_TYPE[RESIDENCE] = []
ARGUMENTS_BY_EVENT_TYPE[FAMILY] = []
ARGUMENTS_BY_EVENT_TYPE[LIVING_SITUATION] = []
ARGUMENTS_BY_EVENT_TYPE[ENVIRO_EXPOSURE] = []
ARGUMENTS_BY_EVENT_TYPE[PHYSICAL_ACTIVITY] = []
ARGUMENTS_BY_EVENT_TYPE[WEIGHT_MANAGE] = []
ARGUMENTS_BY_EVENT_TYPE[SEXUAL_HISTORY] = []
ARGUMENTS_BY_EVENT_TYPE[INFECT_DISEASES] = []
...
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][ALCOHOL] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][DRUG] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][TOBACCO] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][OCCUPATION] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][MARITAL_STATUS] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][RESIDENCE] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][LIVING_SITUATION] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][ENVIRO_EXPOSURE] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][PHYSICAL_ACTIVITY] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][WEIGHT_MANAGE] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][SEXUAL_HISTORY] = [OUTSIDE] + STATUS_TIME_CLASSES
MULTITASK_LABEL_DEF[STATUS_TIME][LAB_MAP][INFECT_DISEASES] = [OUTSIDE] + STATUS_TIME_CLASSES
